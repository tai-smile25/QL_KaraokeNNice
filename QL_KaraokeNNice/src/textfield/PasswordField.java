    ...
    public PasswordField() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                if (showAndHide) {
                    int x = getWidth() - 35;
                    if (new Rectangle(x, 0, 30, 70).contains(me.getPoint())) {
                        hide = !hide;
                        if (hide) {
                            setEchoChar('*');
                        } else {
        ...
        eye = new ImageIcon(getClass().getResource("/Image/view.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/Image/hide.png")).getImage();
